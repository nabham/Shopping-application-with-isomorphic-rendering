...
class SearchBoxComponent extends React.Component{
    ...
    onSearch(){ this.props.history.push('/searchPage/'+this.refs.searchtext.value);
    }

    render(){
    return(<div className={'searchBox'}>
          <input type="text" className={'inputBox'} ref="searchtext" placeholder="Search Product" onChange={this.onchange} />
